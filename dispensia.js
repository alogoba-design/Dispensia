/*****************************************************
 * DISPENSIA – versión estable (desktop + mobile)
 *****************************************************/
...
function renderShopping() {
  ...
  week.forEach(w => {
    ingredientes
      ...
      .forEach(i => {
        const key = `${i.tipo_ingrediente}_${i.ingrediente}_${i.unidad_reg}`;
        if (!map[key]) {
          map[key] = {
        ...
        map[key].qty += Number(i.cantidad_reg) || 0;
      });
  });
